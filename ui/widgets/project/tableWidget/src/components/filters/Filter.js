      ...
      <Grid item xs={5}>
        <FormControl className={classes.formControl}>
          ...
          >
            ...
            <option value="partner_id">{t('entities.project.partner_id')}</option>
            <option value="customer_id">{t('entities.project.customer_id')}</option>
            <option value="procurment_officer_name">
              {t('entities.project.procurment_officer_name')}
            </option>
            <option value="procurment_contact_no">
              {t('entities.project.procurment_contact_no')}
            </option>
            <option value="tickets">{t('entities.project.tickets')}</option>
            <option value="subscriptions">{t('entities.project.subscriptions')}</option>
          </Select>
        </FormControl>
      </Grid>
      <Grid item xs={3}>
