    ...
    <Grid container>
      <Grid item xs={5}>
        <FormControl className={classes.formControl}>
          ...
          >
            <option value="" />
            <option value="level">{t('entities.sub.level')}</option>
            <option value="length">{t('entities.sub.length')}</option>
            <option value="status">{t('entities.sub.status')}</option>
            <option value="project_id">{t('entities.sub.project_id')}</option>
            <option value="start_date">{t('entities.sub.start_date')}</option>
            <option value="customer_id">{t('entities.sub.customer_id')}</option>
          </Select>
        </FormControl>
      </Grid>
      <Grid item xs={3}>
