...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/sub/tableWidget/>):
   1. Run `npm i`
...
- **sub.table.error** (fired when an error occurs)
- **sub.table.select** (fired when a table row is selected)
