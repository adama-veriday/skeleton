...
class SubDetailsElement extends HTMLElement {
  constructor(...args) {
    super(...args);
  ...
  render() {
    const customEventPrefix = 'sub.details.';
    ...
    const ReactComponent = React.createElement(SubDetailsContainer, {
      id,
      onError,
      serviceUrl,
    });
...
customElements.define('sub-details', SubDetailsElement);
